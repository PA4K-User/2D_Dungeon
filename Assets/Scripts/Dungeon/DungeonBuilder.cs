...
public class DungeonBuilder : SingletonMonobehaviour<DungeonBuilder>
{
    ...
    private bool IsOverLappingInterval(int imin1, int imin2, int imax1, int imax2)
    {
    ...
    private Room CreateRoomFromRoomTemplate(RoomTemplateSO roomTemplate, RoomNodeSO roomNode)
    {
        ...
        room.roomLevelEnemySpawnParemetersList = roomTemplate.roomEnemySpawnParametersList;
