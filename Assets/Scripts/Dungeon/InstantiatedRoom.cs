...
public class InstantiatedRoom : MonoBehaviour
{
    ...
    private void BlockDoorwayHorizontally(Tilemap tilemap, Doorway doorway)
    {
        ...
        for (int xPos = 0; xPos < doorway.doorwayCopyTileWidth; xPos++)
        {
            ...
            {
                Matrix4x4 tranformMatrix = tilemap.GetTransformMatrix(new Vector3Int(startPosition.x + xPos, startPosition.y - yPos, 0));
                ...
                tilemap.SetTransformMatrix(new Vector3Int(startPosition.x + 1 + xPos, startPosition.y - yPos, 0), tranformMatrix);
            }
        }
    }
