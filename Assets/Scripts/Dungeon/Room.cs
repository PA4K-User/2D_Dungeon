...
public class Room
{
    ...
    public List<RoomEnemySpawnParameters> roomLevelEnemySpawnParemetersList;
    ...
    {
        foreach (RoomEnemySpawnParameters roomEnemySpawnParameters in roomLevelEnemySpawnParemetersList)
        {
