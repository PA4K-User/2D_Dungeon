...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    [SerializeField] private Transform ammoHolderTranform;
    ...
    private void UpdateAmmoLoadedIcons(Weapon weapon)
    {
        ...
        {
            GameObject ammoIcon = Instantiate(GameResources.Instance.ammoIconPrefab, ammoHolderTranform);
    ...
    private void OnValidate()
    {
        ...
        HelperUtilities.ValidateCheckNullValue(this, nameof(ammoHolderTranform), ammoHolderTranform);
