...
public class AmmoHitEffect : MonoBehaviour
{
    ...
    {
        SetHitEffectColorGradiant(ammoHitEffect.colourGradiant);

        SetHitEffectParticleStartingValue(ammoHitEffect.duration, ammoHitEffect.startParticleSize,
    ...
    private void SetHitEffectColorGradiant(Gradient gradiant)
    {
    ...
    private void SetHitEffectParticleStartingValue(float duration, float startParticleSize, float startParticleSpeed, float startLifeTime, float effectGravity, int maxParticles)
    {
